...
def translate_ui(trans):
    ...
    anchored_points = (trans[1][0] if trans[0][0] == 0 else screensize[0] - trans[1][0] if trans[0][0] == 1 else screensize[0] // 2 + trans[1][0], trans[1][1] if trans[0][1] == 0 else screensize[1] - trans[1][1] if trans[0][1] == 1 else screensize[1] // 2 + trans[1][1], trans[2][0] if trans[0][0] == 0 else screensize[0] - trans[2][0] if trans[0][0] == 1 else screensize[0] // 2 + trans[2][0], trans[2][1] if trans[0][1] == 0 else screensize[1] - trans[2][1] if trans[0][1] == 1 else screensize[1] // 2 + trans[2][1])
